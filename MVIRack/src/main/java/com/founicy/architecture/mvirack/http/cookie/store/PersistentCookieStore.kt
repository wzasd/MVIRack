...
class PersistentCookieStore(context:Context ):CookieStore{
    ...
    companion object{
        var LOG_TAG = "PersistentCookieStore"
        var COOKIE_PREFS = "rack_cookie" //cookie使用prefs保存
        var COOKIE_NAME_PREFIX = "cookie_" //cookie持久化的统一前缀
    ...
    private var cookiePrefs: SharedPreferences = context.getSharedPreferences(COOKIE_PREFS, Context.MODE_PRIVATE)
